function friendController($scope, $http) {    
    ...
    $http.get('/UserInfo/Create/').success(function (data) {          
        $scope.friends = data;  
        $scope.loading = false;  
    })  
    .error(function () {  
    ...
    $scope.save = function () {  
        ...
        alert(emp);  
        $http.put('/UserInfo/Create/', frien).success(function (data) {  
    ...
    $scope.add = function () {          
        $scope.loading = true;  
        $http.post('/UserInfo/Create/', this.newfriend).success(function (data) {  
    ...
    $scope.deletefriend = function () {         
        ...
        $http.delete('/UserInfo/Create/' + friendid).success(function (data) {  
